...
route.put("/:id", async (request, response) => {
    ...
    try {
        ...
        await repositorioPosto.update({id}, {nome_posto, telefone, email, horario_funcionamento, tipo_atendimento, capacidade, servicos_disponiveis, endereco, responsavel});
