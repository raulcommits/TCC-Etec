 ...
 */
module.exports = class Db1760315566704 {
    name = 'Db1760315566704'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`registro_atividade\` (\`id\` int NOT NULL AUTO_INCREMENT, \`data_visita\` datetime NOT NULL, \`registro_visita\` text NOT NULL, \`observacoes\` text NULL, \`agenteId\` int NOT NULL, \`pacienteId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
