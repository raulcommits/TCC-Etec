...
function Agente_altUsuario() {
   ...
   return(
      <div className="app">
         <Header/>
         <Sidenav/>
         <Breadcrumb homeIcon={<img src={HomeAddress} alt="Home" className="breadcrumb-home-icon" />} items={[{ label: 'Home', href: '/Agente_home' }, {label: 'Cadastro de Paciente', href: '/Agente_home-usuario'}, {label: 'Alterar cadastro de paciente', href: '/Agente_alt-usuario'}]} />
         <NavBar items={[
