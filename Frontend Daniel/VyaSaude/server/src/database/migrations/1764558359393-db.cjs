 ...
 */
module.exports = class Db1764558359393 {
    name = 'Db1764558359393'

    /**
     * @param {QueryRunner} queryRunner
     */
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`registro_atividade\` (\`id\` int NOT NULL AUTO_INCREMENT, \`data_visita\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, \`registro_visita\` varchar(255) NOT NULL, \`motivo\` enum ('Cadastramento/Atualização', 'Visita Periódica') NOT NULL, \`desfecho\` enum ('Visita realizada', 'Visita recusada', 'Ausente') NOT NULL, \`descricao\` text NULL, \`agenteId\` int NOT NULL, \`pacienteId\` int NOT NULL, \`enderecoId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
